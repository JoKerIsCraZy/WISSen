 ...
 * Source: raumpläne/4. og.html (JSON backup).
 *
 * Ported verbatim from web/floorplans/data.js — do not regenerate or
 * "improve" these values. The user has tuned them via the standalone editors.
 *
 * Room codes are stored without dots ("403" not "4.03") to match the
 * label rendered on the floor plan and in captions ("208"). normalizeRoom()
 * collapses any input form to this canonical 3-digit form.
 */
...
export const FLOORPLAN_DATA: FloorplanData = {
  og4: {
